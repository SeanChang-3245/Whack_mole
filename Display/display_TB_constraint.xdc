...
# set_property PACKAGE_PIN W19 [get_ports change_sel]
# 	set_property IOSTANDARD LVCMOS33 [get_ports change_sel]
set_property PACKAGE_PIN T17 [get_ports change_pat]
	set_property IOSTANDARD LVCMOS33 [get_ports change_pat]
